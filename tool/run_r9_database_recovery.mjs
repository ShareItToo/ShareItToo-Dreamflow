...
export const r9RequiredMigrationCount = 79;
...
async function readMigrationPlan(root) {
  ...
  if (plan.length !== r9RequiredMigrationCount
      ...
      || plan.at(-1)?.filename !== '079_special_category_intake_minimization.up.sql') {
...
export function validateR9Observation(value, {
  ...
  requiredLastMigration = '079_special_category_intake_minimization.up.sql',
