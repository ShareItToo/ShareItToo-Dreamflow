...
export const r9RequiredMigrationCount = 87;
...
async function readMigrationPlan(root) {
  ...
  if (plan.length !== r9RequiredMigrationCount
      ...
      || plan.at(-1)?.filename !== '087_identity_verification_pilot_gate.up.sql') {
...
export function validateR9Observation(value, {
  ...
  requiredLastMigration = '087_identity_verification_pilot_gate.up.sql',
