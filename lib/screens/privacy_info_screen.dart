    ...
    final sections = <_PrivacySectionData>[
      ...
      const _PrivacySectionData(
        ...
        note:
            ...
            'Eine freiwillige SMS-Bestätigung einer Telefonnummer über Firebase '
            'Authentication bleibt davon getrennt; die nur für den Nachweis '
            'verwendete Firebase-Telefonidentität wird nach serverseitiger '
