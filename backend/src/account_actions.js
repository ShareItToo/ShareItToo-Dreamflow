...
<h2>Welche Daten verarbeitet werden</h2><p>Je nach Nutzung verarbeitet ShareItToo Konto- und Kontaktdaten, Alters- und Einwilligungsstatus, Profilangaben, Inserats- und Bilddaten, Adressen sowie ungefähre oder präzise Standortdaten, Buchungsbeträge und Buchungsstatus, Nachrichten, Bewertungen, Meldungen, Geräte- und Push-Kennungen sowie Sicherheits-, Audit-, Sitzungs- und Crashdiagnosedaten. Eine freiwillige Produktsicherheitsmeldung kann außerdem Angaben zum Produkt, zu Gefahren, Unfällen oder Verletzungen enthalten. Der aktuelle Store-Kandidat aktiviert keine Identitätsprüfung und keine Ausweisprüfung sowie keinen Upload von Identitätsdokumenten; ein getrenntes internes technisches Testangebot (identity-test-staging-only-v1) kann nur in einem ausdrücklich dafür freigegebenen Testsystem verwendet werden und ist kein Store- oder Produktionsangebot. Er erhebt außerdem keine Karten- oder Bankdaten und überträgt kein Echtgeld an Stripe.</p>
<h2 data-sit-identity-notice="identity-test-staging-only-v1 identity-test-consent-art6a identity-test-provider-redaction identity-test-stripe-retention-caveat">Interner Identity-Test (nicht im Store-Kandidaten aktiviert)</h2><p>Ein ausdrücklich getrenntes Testsystem kann einen freiwilligen technischen Ablauf über Stripe Identity anbieten. Zweck ist ausschließlich die technische Ablaufprüfung; eine reale Identität wird nicht bestätigt. Im Provider-Ablauf können Identitätsdokumentbilder, Ausweisnummern, Adressen, Selfie- und Gesichtsaufnahmen, fortgeschrittene Betrugssignale sowie Geräte- und Verbindungsdaten verarbeitet werden. Verwende nur einen vorgesehenen Stripe-Testfall und keine echten Dokumente oder Selfies. SIT erhält und speichert nur technische Sitzungszuordnung, Providerstatus, Zeitpunkte, minimierte Ereignisse und Löschstatus, keine Dateien und keine Zugangsschlüssel. Verantwortlicher für den SIT-Test ist der im Impressum genannte ShareItToo-Betreiber (Kontakt: contact@shareittoo.com); Stripe ist je nach konkretem Zweck eigener Verantwortlicher oder Dienstleister. Die Einwilligung nach Art. 6 Abs. 1 Buchst. a DSGVO ist freiwillig und widerruflich. Nach Ende oder Widerruf wird die Provider-Redaktion angefordert; SIT zeigt bis zur bestätigten Provider-Redaktion „Löschung läuft“ und behauptet keine vollständige Löschung bei Stripe. Unvollständige Eingaben laufen nach 24 Stunden aus; technische Zuordnungen, Ereignisse und Lösch-Tombstones werden höchstens 30 Tage, offene Löschaufträge bis zur Bestätigung aufbewahrt. Mögliche Übermittlungen in die USA oder an Unterauftragnehmer und Schutzmechanismen wie SCC oder EU-US DPF gelten nur, soweit sie im konkreten Stripe-Ablauf anwendbar und offiziell ausgewiesen sind; siehe https://stripe.com/de/legal/privacy-center und https://stripe.com/de/legal/dpa.</p>
